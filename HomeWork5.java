    ...
    */
    ...
    public static class Person {
        ...
        public String announce() {
            return "Person" + this.name + "имеет характеристики: " + this.health + " здоровья и " + this.protection + " защиты";
        }

        public void takeDamage(Integer damage) throws Exception {
            if (damage - this.protection < 0 ) {
                throw new Exception();
            }
            this.health = this.health - (damage - this.protection);
            if (this.health <= 0) {
                this.health = 0;
                throw new PersonDead("R.I.P");
            }
        }
    ...
    public static class Mage extends Person {
        ...
        public void takeDamage(Integer damage) throws Exception {
            try {
                super.takeDamage(damage - this.health % 10);
            } catch (PersonDead e) {
                //System.out.println(e.getMessage());
                throw new PersonDead("Mage R.I.P");
            }
        }
    ...
    public static class Archer extends Person {
        ...
        public void takeDamage(Integer damage) throws Exception {
            try {
                ...
                //System.out.println(e.getMessage());
                throw new PersonDead("Archer R.I.P");
            }
        }
