...
public class  HomeWork3 {
    ...
    public static void raiseException(Integer exceptionId) throws SocketException, ClassNotFoundException, AccessDeniedException, ExportException { // Подсказка: throws Exception в итоге надо поменять на перечисление имен исключений
        ...
        if (exceptionId == 3) {
            throw new AccessDeniedException("text");
        }
        if (exceptionId == 4) {
            throw new ExportException("text");
        }
      //  throw new Exception();
    }

    public static String catchException(Integer integer) throws AccessDeniedException, ClassNotFoundException, ExportException, SocketException {
